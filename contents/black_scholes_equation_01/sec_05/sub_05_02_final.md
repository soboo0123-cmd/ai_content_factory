...
이산수익률 관점에서는 10% 상승 후 10% 하락하더라도 원래 주가로 돌아오지 않습니다.($S_0 = 99$) 5기간 동안의 전체 이산수익률은 개별 수익률 배수의 곱에서 1을 뺀 값입니다.
...
$$\ln(u \cdot d \cdot u \cdot u \cdot d) = \ln(u^3 \cdot d^2) = 3\ln u + 2\ln d$$
