...
따라서 이산의 이정표인 $k$를 연속 정규분포의 면적으로 매핑할 때는, $k$번째 막대의 절반을 포함할 수 있도록 **연속성 수정(Continuity Correction)**을 가하여 경계값을 $k - 0.5$로 하향 조정해 주어야 유한한 $n$ 단계에서 근사 오차를 혁신적으로 줄일 수 있습니다.
...
## [부록] 연속성 수정(Continuity Correction)의 기하학적 원리와 수치적 검증
